...
You can check your User Stories against the solution [here](bobs-bagels-user-stories-domain-models.md)

---

## From User Stories to Domain Models

You will think about your User Stories in terms of Domain Models.  Look at the Domain Models suggested for the User Stories [here](bobs-bagels-user-stories-domain-models.md).
...
- Take each *User Story* and inspect the ***Domain Model*** for it
  - See if it matches the idea of the functionality that you will have started to form in your head!

---

## From Domain Models to Working Code Through TDD
...
- One of the pair should write a failing test for the first test case
- The other person should write the code to make the test pass
